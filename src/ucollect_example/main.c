...
unsigned char *get_random_number() {
	...
	//OK, it is very dummy implementation
	...
	random_number = (unsigned char *)malloc(32);
	memcpy(random_number, data, 32);
