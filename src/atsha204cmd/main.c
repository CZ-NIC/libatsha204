...
void help(char *prgname) {
	fprintf(stderr,
		...
		"Available [command] options:\n"
			...
			"\t%s\tprint HMAC response of SHA256 hash from stdin to stdout\n"
			"\t%s\tprint HMAC response of data from stdin to stdout\n"
		...
		"Input/Output on stdin/stdout (except MAC addresses and stdin data) is in format:\n"
			"\t00112233...\tor\n"
			"\t00 11 22 33...\tor\n"
			"\t00:11:22:33...\tor\n"
			"\t00;11;22;33...\tor\n"
